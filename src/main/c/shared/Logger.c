...
static const char* _toContextString(const LoggingLevel loggingLevel) {
	switch (loggingLevel) {
		case ALL: return "[ALL  ]";
		case DEBUGGING: return "[" DEBUGGING_COLOR "DEBUG" DEFAULT_COLOR "]";
		case INFORMATION: return "[" INFORMATION_COLOR "INFO " DEFAULT_COLOR "]";
		case WARNING: return "[" WARNING_COLOR "WARN " DEFAULT_COLOR "]";
		case ERROR: return "[" ERROR_COLOR "ERROR" DEFAULT_COLOR "]";
		default: return "[" CRITICAL_COLOR "FATAL" DEFAULT_COLOR "]";
	}
}
